...
function SimpleForm(props) {
  ...
  const buttonStyle = {
    ...
    return (
      <>
        <Modal open={props.openModal} onClose={() => {props.setOpenModal(false);}} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        <Box sx={style}>
        <ChatBot
        steps={[   //Intents of the chatbot
            ...
            <Button variant="outlined" onClick={() => {props.setOpenModal(false);}} sx={buttonStyle}>
                Close
              </Button>
            </Box>
         </Modal>
